...
import pickle
import time
from correlate_parameters_WASP127_2  import *
import correlate_functions_onlyPCA as corr_func
...
for nobs in range(num_obs):
    ...
    list_ord,wl,data_tot,phase,window,Stdtot,SNRtot,projtot,fluxtot,F,Vc,berv = corr_func.load_data(filename,select_ord,list_ord1,dire_mod)
    ...
    if parallel:
        ...
        correl_boucher_subset = corr_func.perform_correlation(orders_to_process,\
                                                   ...
                                                   fluxtot[start_order:end_order+1],\
    ...
    #or just in sequential    
        ...
        correl_boucher = corr_func.perform_correlation(list_ord, data_tot, \
                                                       projtot, fluxtot,Stdtot, SNRtot, F2D, \
